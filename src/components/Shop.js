    ...
    <div className="shop_container">
      <div className="shop_wrapper">
        <aside className="shop_side">
          <h2 className="shop_side-title">
            Products/<span>{currentFilter}</span>
          </h2>
        ...
        <main className="shop_main">
          <ul className="items_list">
            {dataToPrint.length ? (
              ...
              <div className="empty">
                There is no Plants in this category. <br /> Check again in a few
                days!
              </div>
            )}
          </ul>
